...
public class Main {
    ...
    private static void pil() throws ParseException, IOException{
            ...
            switch(pilih){
                ...
                case 2:
                    ...
                    System.out.print("no: ");
                    int Awno = Integer.parseInt(input.readLine());
    ...
    private static void add() throws ParseException, IOException{
        ...
        for(int i = 0; i < batasan; i++){
            ...
            FormPesanan pesanan_baru = new FormPesanan(pemesan, No_pesanan, nomor_telepon, nomor_antrian,Alamat);
            System.out.println("");
    ...
    private static void view() throws IOException{
        ...
        for(int i = 0; i < Datapesanan.size(); i++){
            ...
            System.out.println("ALAMAT          >>>    " + Datapesanan.get(i).getAlamat());
            System.out.println("===========================================");
            System.out.println("");
            System.out.println("TEKAN ENTER UNTUK MELANJUTKAN. . .");input.readLine();
        }
